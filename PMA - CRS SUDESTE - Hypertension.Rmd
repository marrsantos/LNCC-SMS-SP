...
subtitle: Patient journey (Hypertension) - LNCC (Part 6/6)
...
```{r}
# Filtering Hypertension - O13, O140, O141, O149, O150, O151, O152, O159, O16
dfevents<-subset(dfevents,substring(codigocid,1,3) %in% c('O13','O14','O15','O16'))
```
...
#### CRS SUDESTE Analysis

```{r echo=FALSE}
dfcnstipo <- subset(dfcnstipoAll, h2nomenivel2a=='CRS SUDESTE')
```
...
a<- logevents %>%
    ...
    rm(logevents)
```
The Figure 21 illustrates the type of facilities and the absolute frequency of times people pass in this way during their journey in the public healthcare system in Sao Paulo municipality - CRS SUDESTE.

```{r echo=FALSE, fig.height=4, fig.width=9}
a %>% process_map()
```
Figure 21 - Process map of Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS SUDESTE.

The idle time during the paths followed by citizens is shown in the Figure 22.
...
```
Figure 22 - Process map including absolute frequency and idle time of Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS SUDESTE.  

Idle time during paths and relative frequency for the facilities type is illustrated in the Figure 23.
...
a %>% process_map(type_nodes = frequency("relative"),
            type_edges = performance(median, "days"))
```
Figure 23 - Process map including relative frequency and idle time registered during the Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS SUDESTE. 

The summary of antecedent and consequent type of facility is presented in the Figure 24.
...
```
Figure 24 - Summary of antecedent and consequent type of facility for the Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS SUDESTE.
