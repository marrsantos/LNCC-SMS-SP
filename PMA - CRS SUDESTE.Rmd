...
subtitle: Patient journey - LNCC (Part 6/6)
...
a %>% process_map()
```
Figure 21 - Process map of Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - CRS SUDESTE.
...
```
Figure 22 - Process map including absolute frequency and idle time of Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - CRS SUDESTE.  
...
a %>% process_map(type_nodes = frequency("relative"),
            type_edges = performance(median, "days"))
```
Figure 23 - Process map including relative frequency and idle time registered during the Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - CRS SUDESTE. 
...
```
Figure 24 - Summary of antecedent and consequent type of facility for the Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - CRS SUDESTE.
