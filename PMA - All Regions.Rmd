...
subtitle: Patient journey - LNCC (Part 1/6)
...
This document includes preliminary journey of patients analysis based on the Process Mining framework. We decided to analyze Prenatal, childbirth and Postpartum data once it is considered a bit more predictable in terms of journey than other clinical scenarios.  
In this sense, we included in this document some preliminary PMA graphics and tables aiming to reveal a first impression of the patient journey in the São Paulo municipality for Prenatal, Childbirth and Postpartum activities. Also, we performed the same analysis to the five regions where the healthcare services are currently structured. Only data collected in 2015 were analyzed in this preliminary experiment.
...
a %>% process_map()
```
Figure 1 - Process map of Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - All Regions
...
```
Figure 2 - Process map including absolute frequency and idle time of Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - All Regions.  
...
a %>% process_map(type_nodes = frequency("relative"),
            type_edges = performance(median, "days"))
```
Figure 3 - Process map including relative frequency and idle time registered during the Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - All Regions. 
...
```
Figure 4 - Summary of antecedent and consequent type of facility for the Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - All Regions.
