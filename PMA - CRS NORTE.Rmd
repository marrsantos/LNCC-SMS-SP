...
subtitle: Patient journey - LNCC (Part 5/6)
...
a %>% process_map()
```
Figure 17 - Process map of Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - CRS NORTE.
...
```
Figure 18 - Process map including absolute frequency and idle time of Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - CRS NORTE.  
...
a %>% process_map(type_nodes = frequency("relative"),
            type_edges = performance(median, "days"))
```
Figure 19 - Process map including relative frequency and idle time registered during the Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - CRS NORTE. 
...
```
Figure 20 - Summary of antecedent and consequent type of facility for the Prenatal, Childbirth and Postpartum activities performed in the Municipality of São Paulo in 2015 - CRS NORTE.
