...
subtitle: Patient journey (Hypertension) - LNCC (Part 2/6)
...
a %>% process_map()
```
Figure 5 - Process map of Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS CENTRO OESTE.
...
```
Figure 6 - Process map including absolute frequency and idle time of Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS CENTRO OESTE.  
...
a %>% process_map(type_nodes = frequency("relative"),
            type_edges = performance(median, "days"))
```
Figure 7 - Process map including relative frequency and idle time registered during the Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS CENTRO OESTE. 
...
```
Figure 8 - Summary of antecedent and consequent type of facility for the Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS CENTRO OESTE.
