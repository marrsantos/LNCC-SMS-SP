...
subtitle: Patient journey (diabetes) - LNCC (Part 4/6)
...
```{r echo=FALSE}
dfcnstipo <- subset(dfcnstipoAll, h2nomenivel2a=='CRS SUL')
```
...
a %>% process_map()
```
Figure 13 - Process map of Prenatal, Childbirth and Postpartum activities related to Diabetes patients performed in the Municipality of São Paulo in 2015 - CRS SUL.
...
```
Figure 14 - Process map including absolute frequency and idle time of Prenatal, Childbirth and Postpartum activities related to Diabetes patients performed in the Municipality of São Paulo in 2015 - CRS SUL.  
...
a %>% process_map(type_nodes = frequency("relative"),
            type_edges = performance(median, "days"))
```
Figure 15 - Process map including relative frequency and idle time registered during the Prenatal, Childbirth and Postpartum activities related to Diabetes patients performed in the Municipality of São Paulo in 2015 - CRS SUL. 
...
```
Figure 16 - Summary of antecedent and consequent type of facility for the Prenatal, Childbirth and Postpartum activities related to Diabetes patients performed in the Municipality of São Paulo in 2015 - CRS SUL.
