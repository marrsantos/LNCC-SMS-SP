...
subtitle: Patient journey (Hypertension) - LNCC (Part 3/6)
...
```{r echo=FALSE}
dfcnstipo <- subset(dfcnstipoAll, h2nomenivel2a=='CRS LESTE')
```
...
a %>% process_map()
```
Figure 9 - Process map of Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS LESTE.
...
```
Figure 10 - Process map including absolute frequency and idle time of Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS LESTE.  
...
a %>% process_map(type_nodes = frequency("relative"),
            type_edges = performance(median, "days"))
```
Figure 11 - Process map including relative frequency and idle time registered during the Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS LESTE. 
...
```
Figure 12 - Summary of antecedent and consequent type of facility for the Prenatal, Childbirth and Postpartum activities related to Hypertension patients performed in the Municipality of São Paulo in 2015 - CRS LESTE.
